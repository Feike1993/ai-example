...
见 [phase13.md](phase13.md)：进阶 15 样例按主题分组（检索 / 记忆 / MCP / 可观测 / 护栏），无新样例文档号。
...
| **进阶** | Hybrid、评测、持久会话、长期记忆、MCP 远端、HyDE、分块、抽记忆、MCP 鉴权、可观测流式、护栏与引用、记忆×检索闭环；第十三期侧栏分组 | **第四～十三期** |

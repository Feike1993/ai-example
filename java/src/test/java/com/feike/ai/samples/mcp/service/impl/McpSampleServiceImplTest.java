package com.feike.ai.samples.mcp.service.impl;

import com.feike.ai.samples.mcp.config.McpToolConfiguration;
...
class McpSampleServiceImplTest {
    ...
    private static McpSampleService newService(
        ...
        return new McpSampleServiceImpl(registry, properties, serverTools, clientTools, syncClients);
    }
}

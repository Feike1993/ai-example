...
public class JdbcChatSessionDAOImpl implements ChatSessionDAO {

    private final JdbcTemplate jdbcTemplate;

    public JdbcChatSessionDAOImpl(JdbcTemplate jdbcTemplate) {
    ...
    public List<Message> snapshot(String sessionId) {
        List<Message> messages = jdbcTemplate.query(
            """
                ...
                """,
            (rs, rowNum) -> ChatSessionDAO.fromRole(rs.getString("role"), rs.getString("content")),
            sessionId
        );

package com.feike.ai.samples.context.dao;
...
public interface ChatSessionDAO {
     ...
     */
    default List<MessageVO> views(String sessionId) {
        List<MessageVO> views = new ArrayList<>();
        for (Message message : snapshot(sessionId)) {
            views.add(new MessageVO(roleOf(message), textOf(message)));
        }
        return views;
    }
     ...
     * @param content 文本
     */
    record MessageVO(String role, String content) {}

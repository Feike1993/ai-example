package com.feike.ai.samples.multiagent.service.impl;
 ...
 */
@Service
public class MultiAgentSampleServiceImpl implements MultiAgentSampleService {
     ...
     */
    public MultiAgentSampleServiceImpl(
